...
public class Constants {
    ...
    public static final class PHOTON_VISION {
        ...
        public static final class SNAPSHOT_PARAM {
            public static final int MAX_SNAPSHOTS = 150; // number of snapshots before stop
            public static final long MIN_SNAPINTERVAL_MS = 1000; // milliseconds between captures
        }
    ...
    public static final class CAN_ID {
        ...
        public static final int FLOOR_MOTOR = 23; // TODO: make sure that the old spindexter motor is the same for the
                                                  // floor
    ...
    public static final class INTAKE_PIVOT {
        ...
        public static final SparkBaseConfig INTAKE_PIVOT_BASE_CONFIG = new SparkMaxConfig()
        ...
        // When intake is zeroed at the upper hard stops, fully deployed is about -160
        // rotations
    ...
    public static final class SHOOTER {
        ...
        public static final SimpleMotorFeedforward FEEDFORWARD = new SimpleMotorFeedforward(0.12, 0.125, 0.01);
