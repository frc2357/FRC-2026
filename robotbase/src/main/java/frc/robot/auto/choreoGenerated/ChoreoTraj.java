...
public record ChoreoTraj(
    ...
    public static final ChoreoTraj FlipTest = new ChoreoTraj(
	    "FlipTest",
	    OptionalInt.empty(),
	    2.85316,
	    new Pose2d(1.373, 6.953, Rotation2d.fromRadians(0)),
	    new Pose2d(1.374, 6.947, Rotation2d.fromRadians(0))
	);
	public static final ChoreoTraj Crab = new ChoreoTraj(
	    "Crab",
	    OptionalInt.empty(),
	    0.66485,
	    new Pose2d(2.062, 7.364, Rotation2d.fromRadians(0)),
	    new Pose2d(2.096, 5.99, Rotation2d.fromRadians(0))
	);
