...
public class CommandSwerveDrivetrain
  ...
  public void driveFieldRelative(LinearVelocity x, LinearVelocity y, AngularVelocity rotation) {
    this.setControl(m_driveFieldCentric.withVelocityX(x).withVelocityY(y).withRotationalRate(rotation));
  }

  public void stopMotors() {
    driveFieldRelative(MetersPerSecond.zero(), MetersPerSecond.zero(), RadiansPerSecond.zero());
